...
namespace Papyrus.Language.Components {
    public class ParameterList : IList<Parameter>, IReadOnlyList<Parameter>, ICollection<Parameter>, IReadOnlyCollection<Parameter>, IEnumerable<Parameter>, IEnumerable, ICloneable {
